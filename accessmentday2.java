...
public class accessmentday2 {
	...
	public void Salesforcelogin() {
		...
		// Enter first name
		driver.findElement(By.xpath("//input[@placeholder='First Name']")).sendKeys("Shankari");
		...
		driver.findElement(By.xpath("//label[text()='Email']/following::input"))
				.sendKeys("shankariselvi@gmail.com");
